#!/usr/bin/env python3
"""Cold-start operate — elite leaf bar entry for opera-neon-spatial-workspace.
...
MOD = "opera_neon_spatial_workspace"
...
def main() -> int:
    ...
    try:
        ...
        out = {
            "repository": "GlacierEQ/opera-neon-spatial-workspace",
            "module": imported_as,
