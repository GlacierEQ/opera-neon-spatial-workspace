...
class AdversarialEliteTests(unittest.TestCase):
    def _load(self):
        errors = []
        for name in ('opera_neon_spatial_workspace', "src." + 'opera_neon_spatial_workspace'):
            try:
    ...
    def test_refuse_bad_import_path_does_not_shadow(self):
        with self.assertRaises(ModuleNotFoundError):
            importlib.import_module("src.__elite_does_not_exist_" + 'opera_neon_spatial_workspace')
